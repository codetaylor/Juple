...
package com.sudoplay.juple.classparser.annotations;
...
/**
 * An annotation that indicates this member should be exposed for TML
...
public @interface Expose {
   ...
   * the TML while serializing. If {@code false}, the field marked with this
   ...
   * the TML. If {@code false}, the field marked with this annotation is skipped
