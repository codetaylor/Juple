...
public class TMLType {
  ...
  public static Class<?> getRawType(Type type) {
    if (type instanceof Class<?>) {
      ...
      TMLContract.checkArgument(rawType instanceof Class);
   ...
   * {@code Set.class} is {@code Set<Integer>} and the result when the supertype
   * is {@code Collection.class} is {@code Collection<Integer>}.
   */
   ...
   * {@code ArrayList<String>}, this returns {@code Iterable<String>} given the
  ...
  static Type getSupertype(Type context, Class<?> contextRawType,
      Class<?> supertype) {
    TMLContract.checkArgument(supertype.isAssignableFrom(contextRawType));
    return resolve(context, contextRawType,
        TMLType.getGenericSupertype(context, contextRawType, supertype));
  }
  ...
  public static Type getArrayComponentType(Type array) {
    return array instanceof GenericArrayType ? ((GenericArrayType) array)
        .getGenericComponentType() : ((Class<?>) array).getComponentType();
  }
  ...
  public static Type[] getMapKeyAndValueTypes(Type context,
    ...
    if (context == Properties.class) {
      return new Type[] { String.class, String.class }; // TODO: test subclasses
                                                        // of Properties!
    }
  ...
  public static Type resolve(Type context, Class<?> contextRawType,
      Type toResolve) {
    // this implementation is made a little more complicated in an attempt to
  ...
  private static final class ParameterizedTypeImpl implements
    ...
    public ParameterizedTypeImpl(Type ownerType, Type rawType,
      ...
      if (rawType instanceof Class<?>) {
        ...
        TMLContract.checkArgument(ownerType != null
      ...
      for (int t = 0; t < this.typeArguments.length; t++) {
        TMLContract.checkNotNull(this.typeArguments[t]);
        TMLContract.checkNotPrimitive(this.typeArguments[t]);
    ...
    public boolean equals(Object other) {
      return other instanceof ParameterizedType
          && TMLType.equals(this, (ParameterizedType) other);
    }
  ...
  private static final class GenericArrayTypeImpl implements GenericArrayType,
    ...
    public boolean equals(Object o) {
      return o instanceof GenericArrayType
          && TMLType.equals(this, (GenericArrayType) o);
    }
  ...
  private static final class WildcardTypeImpl implements WildcardType,
    ...
    public WildcardTypeImpl(Type[] upperBounds, Type[] lowerBounds) {
      TMLContract.checkArgument(lowerBounds.length <= 1);
      TMLContract.checkArgument(upperBounds.length == 1);

      if (lowerBounds.length == 1) {
        TMLContract.checkNotNull(lowerBounds[0]);
        TMLContract.checkNotPrimitive(lowerBounds[0]);
        TMLContract.checkArgument(upperBounds[0] == Object.class);
        this.lowerBound = canonicalize(lowerBounds[0]);
        this.upperBound = Object.class;

      } else {
        TMLContract.checkNotNull(upperBounds[0]);
        TMLContract.checkNotPrimitive(upperBounds[0]);
    ...
    public boolean equals(Object other) {
      return other instanceof WildcardType
          && TMLType.equals(this, (WildcardType) other);
    }
