 ...
 * 
 * @author Kevin Bourrillion (original for gson)
 * @author Jason Taylor (modified for Juple)
 */
public final class TMLPrimitives {
  private TMLPrimitives() {
    //
  }
  ...
  public static boolean isWrapperType(Type type) {
    return WRAPPER_TO_PRIMITIVE_TYPE
        .containsKey(TMLContract.checkNotNull(type));
  }
  ...
  public static boolean isPrimitiveOrWrapperArray(Type type) {
    return ((Class<?>) type).isArray() == false && isPrimitiveOrWrapper(type);
  }
  ...
  public static <T> Class<T> wrap(Class<T> type) {
    ...
    Class<T> wrapped = (Class<T>) PRIMITIVE_TO_WRAPPER_TYPE.get(TMLContract
        .checkNotNull(type));
  ...
  public static <T> Class<T> unwrap(Class<T> type) {
    // cast is safe: long.class and Long.class are both of type Class<Long>
    @SuppressWarnings("unchecked")
    Class<T> unwrapped = (Class<T>) WRAPPER_TO_PRIMITIVE_TYPE.get(TMLContract
        .checkNotNull(type));
