 ...
 */
public abstract class TMLUnsafeAllocator {
  public abstract <T> T newInstance(Class<T> c) throws Exception;

  public static TMLUnsafeAllocator create() {
    // try JVM
    // public class Unsafe {
    ...
    try {
      ...
      final Method allocateInstance = unsafeClass.getMethod("allocateInstance",
          Class.class);
      return new TMLUnsafeAllocator() {
        @Override
