 ...
 * 
 * <p>
 * {@code TMLTypeToken<List<String>> list = new TMLTypeToken<List<String>>() ;}
 * 
 * <p>
...
public class TMLTypeToken<T> {
  ...
  protected TMLTypeToken() {
    this.type = getSuperclassTypeParameter(getClass());
    this.rawType = (Class<? super T>) TMLType.getRawType(type);
   ...
   */
  @SuppressWarnings("unchecked")
  TMLTypeToken(Type type) {
    this.type = TMLType.canonicalize(TMLContract.checkNotNull(type));
    this.rawType = (Class<? super T>) TMLType.getRawType(this.type);
    this.hashCode = this.type.hashCode();
  }

  /**
   * Returns the type from super class's type parameter in
   * {@link TMLType#canonicalize canonical form}.
   */
  static Type getSuperclassTypeParameter(Class<?> subclass) {
    ...
    return TMLType.canonicalize(parameterized.getActualTypeArguments()[0]);
  }
  ...
  public final boolean equals(Object o) {
    return o instanceof TMLTypeToken<?>
        && TMLType.equals(type, ((TMLTypeToken<?>) o).type);
  }

  @Override
  public final String toString() {
    return TMLType.typeToString(type);
  }

  /**
   * Gets type literal for the given {@code Type} instance.
   */
  public static TMLTypeToken<?> get(Type type) {
    return new TMLTypeToken<Object>(type);
  }

  /**
   * Gets type literal for the given {@code Class} instance.
   */
  public static <T> TMLTypeToken<T> get(Class<T> type) {
    return new TMLTypeToken<T>(type);
  }
  ...
  public boolean isAssignableFrom(Type from) {
    ...
    if (type instanceof Class<?>) {
      return rawType.isAssignableFrom(TMLType.getRawType(from));
   ...
   */
  @Deprecated
  public boolean isAssignableFrom(TMLTypeToken<?> token) {
  ...
  private static boolean isAssignableFrom(Type from, ParameterizedType to,
    ...
    Class<?> clazz = TMLType.getRawType(from);
