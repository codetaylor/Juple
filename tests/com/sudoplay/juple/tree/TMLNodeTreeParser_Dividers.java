...
public class TMLNodeTreeParser_Dividers {
  ...
  public TMLNodeTreeParser_Dividers(String input, String expectedOutput) {
    this.input = input;
  ...
  public static Collection<Object[]> data() {
    ...
    list.add(new Object[] { "[ position | 1 2 3 ]", "[[position] [1 2 3]]" });
    list.add(new Object[] { "[ a | b | c ]", "[[a] [b] [c]]" });
    list.add(new Object[] { "[ a b c | d | e | f ]", "[[a b c] [d] [e] [f]]" });
    list.add(new Object[] { "[ a b c | d [ 1 | 2 [ | ] | [ 3 ] ] | e | f ]",
        "[[a b c] [d [[1] [2 [[] []]] [[3]]]] [e] [f]]" });
    return list;
  }
