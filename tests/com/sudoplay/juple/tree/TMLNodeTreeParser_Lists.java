...
public class TMLNodeTreeParser_Lists {
  ...
  public TMLNodeTreeParser_Lists(String input, String output) {
    this.input = input;
  ...
  public static Collection<Object[]> data() {
    ...
    list.add(new Object[] { "[a b c d]", "[a b c d]" });
    list.add(new Object[] { "[[blah blah] 1 2 3 [[x] [y]]]",
        "[[blah blah] 1 2 3 [[x] [y]]]" });
    return list;
  }
