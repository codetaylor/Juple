...
public class TMLNodeTreeParser_Escapes {
  ...
  public TMLNodeTreeParser_Escapes(String input, String output) {
    this.input = input;
  ...
  public static Collection<String[]> data() {
    ...
    list.add(new String[] { "[\\[ open bracket]", "[[ open bracket]" });
    list.add(new String[] { "[\\] close bracket]", "[] close bracket]" });
    list.add(new String[] { "[\\| divider]", "[| divider]" });
    list.add(new String[] { "[\\n new line]", "[\n new line]" });
    list.add(new String[] { "[\\r return]", "[\r return]" });
    list.add(new String[] { "[\\ttab]", "[\ttab]" });
    list.add(new String[] { "[\\s space]", "[  space]" });
    list.add(new String[] { "[\\\\ backslash]", "[\\ backslash]" });
    list.add(new String[] { "[\\?]", "[\\?]" });
    list.add(new String[] { "[\\*]", "[\\*]" });
    return list;
  }
